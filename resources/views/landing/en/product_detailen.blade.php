...
<head>
    ...
    <title>Product Detail - {{ $setting->company_name ?? 'PT. Inti Semai Kaliandra' }}</title>
    ...
    <style>
        * {
        ...
        /* When hidden overlay shouldn't capture clicks */
        ...
        /* Extra small mobile and parity tweaks (match ID navbar at small widths) */
...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="{{ route('contact.en') }}" class="nav-link">Contact</a></li>
            </ul>
            <div class="nav-right">
    ...
    <div class="container">
        <div class="back-btn-wrapper">
            <a href="{{ route('products.en') }}" class="back-btn">
                    ...
                    <div class="swiper product-swiper" id="productSwiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <button class="zoom-btn" onclick="openZoom(this)" title="Zoom image">
        ...
        <div class="footer-container">
            <div class="footer-about">
                ...
                @else
                    ...
                    Blok B No. 9, Jl. Untung Suropati, Karang Asem Ulu,<br>
            ...
            <div class="footer-section">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('contact.en') }}">Contact</a></li>
                </ul>
            </div>
            <div class="footer-section footer-location" style="text-align: center;">
                ...
                @else
                    <div class="map-container">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.817!2d117.15!3d-0.50!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMMKwMzAnMDAuMCJTIDExN8KwMDknMDAuMCJF!5e0!3m2!1sen!2sid!4v1234567890"
