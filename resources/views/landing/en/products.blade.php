    ...
    <style>
       ...
       /* Navbar */
        ...
        .product-card {
            ...
            padding-bottom: 100px; /* Space for absolutely-positioned buttons */
            display: flex;
            flex-direction: column;
            align-items: center;
            width: 100%;
        ...
        @media (max-width: 767px) {
            ...
            .footer {
                padding: 32px 16px 16px; /* 40px 20px 20px * 0.8 */
            }
            ...
            .whatsapp-button {
                padding: 9.6px 16px; /* 12px 20px * 0.8 */
        ...
        @media (max-width: 480px) {
            ...
            .product-card {
                min-height: 280px; /* Reduced for more square layout */
            ...
            .product-image-container {
                height: 140px; /* Reduced for more square layout */
                padding: 9.6px; /* 12px * 0.8 */
            }
            ...
            .detail-button {
                ...
                position: relative;
                padding: 9.6px 12.8px; /* 12px 16px * 0.8 */
                margin-top: 16px; /* Add gap from product-spec */
                margin-left: 0;
                margin-right: 0;
            }
            ...
            .product-links {
                ...
                justify-content: center;
                padding: 9.6px 0;
                margin-top: 12px; /* Add gap from product-spec */
            }
            ...
            .load-more-btn {
                font-size: 0.8rem; /* 1rem * 0.8 */
                padding: 4.8px 14.4px; /* 6px 18px * 0.8 */
            }

            .footer {
                padding: 24px 12px 12px; /* 30px 15px 15px * 0.8 */
            }
            ...
            .whatsapp-button {
                padding: 8px 12.8px; /* 10px 16px * 0.8 */
            }
...
<body>
    ...
    <section class="hero" id="products" @if($setting && $setting->hero_image) style="background: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('{{ $setting->hero_image_url }}'); background-size: cover; background-position: center;" @endif>
        <div class="hero-content">
            <h1>{{ $landing->hero_subtitle_top_en ?? 'Our Products' }}</h1>
        </div>
    </section>
    ...
    <div class="product-grid" id="productGrid">
        @foreach($products as $i => $product)
            <div class="product-card product-card-toggle" data-index="{{ $i }}" style="{{ $i > 1 ? 'display:none;' : '' }}">
                ...
                <div class="product-spec">{{ Str::limit($product->description_en, 50, '...') }}</div>
