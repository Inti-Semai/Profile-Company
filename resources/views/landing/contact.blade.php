...
<head>
    ...
    <title>Hubungi Kami - {{ $setting->company_name ?? 'PT. Inti Semai Kaliandra' }}</title>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="{{ route('contact') }}" class="nav-link active">Hubungi Kami</a></li>
            </ul>
    ...
    <section class="contact-section">
        <div class="contact-container">
            ...
            <div class="contact-info">
                ...
                <h4 style="margin-top: 30px; margin-bottom: 15px; font-size: 18px; font-weight: 600;">Terhubung dengan kami!</h4>
            ...
            <div class="contact-form-wrapper">
                ...
                <form action="{{ route('contact.submit') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label>Institusi Anda<span class="required">*</span></label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="telepon" class="form-control" value="{{ old('telepon') }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        <label>Pesan Anda<span class="required">*</span></label>
                        <textarea name="pesan" class="form-control" required>{{ old('pesan') }}</textarea>
                    </div>
